...
namespace ShopSample6.Tests
{
    public class DiscountManagerTests
    {
        private readonly DiscountManager discountManagerSUT =
            new DiscountManager(new DefaultAccountDiscountCalculatorFactory(), new DefaultLoyaltyDiscountCalculator());
        ...
        public void CalculateFourthTypeTest()
        {
            ...
            var expectedResult = price - DiscountConstants.DiscountForMostValuableCustomers * price;
        ...
        public void CalculateSecondTypeTest()
        {
            ...
            var discountForLoyaltyInPercentage =
                timeOfHavingAccountInYears > DiscountConstants.MaximumDiscountForLoyalty
                    ? (decimal) DiscountConstants.MaximumDiscountForLoyalty / 100
                    : (decimal) timeOfHavingAccountInYears / 100;
            var expectedResult = price - DiscountConstants.DiscountForSimpleCustomers * price;
            expectedResult = expectedResult - discountForLoyaltyInPercentage * expectedResult;
        ...
        public void CalculateThirdTypeTest()
        {
            ...
            var discountForLoyaltyInPercentage =
                timeOfHavingAccountInYears > DiscountConstants.MaximumDiscountForLoyalty
                    ? (decimal) DiscountConstants.MaximumDiscountForLoyalty / 100
                    : (decimal) timeOfHavingAccountInYears / 100;
            var expectedResult = price - DiscountConstants.DiscountForValuableCustomers * price;
            expectedResult = expectedResult - discountForLoyaltyInPercentage * expectedResult;
