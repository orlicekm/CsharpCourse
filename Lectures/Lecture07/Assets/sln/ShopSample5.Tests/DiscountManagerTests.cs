...
namespace ShopSample5.Tests
{
    public class DiscountManagerTests
    {
        ...
        public void CalculateFourthTypeTest()
        {
            ...
            var discountForLoyaltyInPercentage = (timeOfHavingAccountInYears > constants.MaximumDiscountForLoyalty) ? (decimal)constants.MaximumDiscountForLoyalty / 100 : (decimal)timeOfHavingAccountInYears / 100;
        ...
        public void CalculateMaxTypeTest()
        {
            ...
            Assert.Throws<NotImplementedException>(() => discountManagerSUT.ApplyDiscount(price, type, timeOfHavingAccountInYears));
        }
