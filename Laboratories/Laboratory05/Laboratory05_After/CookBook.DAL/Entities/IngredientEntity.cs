namespace CookBook.DAL.Entities
{
    public class IngredientEntity : EntityBase
    {
        ...
        public static IEqualityComparer<IngredientEntity> DescriptionNameIdComparer { get; } =
            new DescriptionNameIdEqualityComparer();
        ...
        private sealed class DescriptionNameIdEqualityComparer : IEqualityComparer<IngredientEntity>
        {
            public bool Equals(IngredientEntity x, IngredientEntity y)
            {
                ...
                return string.Equals(x.Description, y.Description) && string.Equals(x.Name, y.Name) &&
                       x.Id.Equals(y.Id);
            }
